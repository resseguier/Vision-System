...
#include "sci_types.h"
    ...
    */
    BOOL2 StartScilab(char *SCIpath, char *ScilabStartup, int Stacksize);
     ...
     */
    int Call_ScilabOpen(char* SCIpath, BOOL2 advancedMode, char *ScilabStartup, int Stacksize);
     ...
     * @return TRUE if it is OK else FALSE
    */
    BOOL2 TerminateScilab(char *ScilabQuit);
    ...
    **/
     ...
     * @return
    **/
    BOOL2 GetLastJob(char *JOB, int nbcharsJOB);
