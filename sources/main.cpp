...
int main( int argc, char** argv ) {
    ...
    if( lodepng_decode32_file(&picture, &camWidth, &camHeight, "stereo_d.png") ) return -4 ;
    ...
    visionImageAlloc(image1, camWidth, camHeight) ;
    visionPicture3Image(picture, image1) ;
    ...
    while( done != 10 ) {
        ...
        while(SDL_PollEvent(&event)) {
            ...
            if( !reset ) {
                ...
                else if(SDL_GetKeyState(NULL)[SDLK_n])
                    night = night==1?0:1 ;
